...
export const VORSCHLAEGE = {
  ...
  klavier: [
    { titel: "Menuette aus dem Notenbüchlein für Anna Magdalena Bach (das bekannte in G-Dur ist von Christian Petzold)" },
  ...
  },
  {
    ...
    punkte: [
      { id: "klavier1", art: "klavier", titel: "Klavierstück 1",
        ...
        werkzeug: { tab: "technik", tool: "klavierstueck", name: "Klavierstück üben" } },
      { id: "klavier2", art: "klavier", titel: "Klavierstück 2",
        ...
        werkzeug: { tab: "technik", tool: "klavierstueck", name: "Klavierstück üben" } },
      { id: "kadenzen", art: "abdeckung", titel: "Kadenzen",
        ...
        werkzeug: { tab: "technik", tool: "kadenzen", name: "Kadenzen" } },
      { id: "klavierblatt", art: "pruefpunkt", titel: "Blattspiel am Klavier",
        ...
        werkzeug: { tab: "technik", tool: "klavierblatt", name: "Klavier-Blattspiel" } },
    ],
  },
  {
    id: "hoeren",
